...
Both files have all results already printed, but if needed, the user can reexecute all of the cells sequentially in the order they're presented in in each file. Regarding the second file, running the cells will require the three csv files given in the .zip file this README file is contained in. These CSVs are the resulting cost matrices of the first file.